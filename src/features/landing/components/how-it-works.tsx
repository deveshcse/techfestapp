      ...
      <div className="landing-container">
        ...
        <div className="relative mt-14 grid gap-10 sm:mt-16 lg:grid-cols-3 lg:gap-8">
          {howItWorks.steps.map((step, index) => (
            <Reveal key={step.title} delayMs={index * 90} className="relative">
              ...
              <div className="group flex flex-col items-start text-left">
                <span className="flex size-12 items-center justify-center border border-landing-primary bg-landing-accent-soft font-landing-display text-lg font-bold text-landing-primary transition-[background-color,color,transform] duration-300 group-hover:scale-105 group-hover:bg-landing-primary group-hover:text-white">
