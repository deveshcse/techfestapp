...
export function SocialProof() {
  ...
  return (
    <section
      className={`border-y border-landing-ink/8 bg-landing-surface py-(--landing-section-y-compact)`}
    >
      ...
      <div className={`relative overflow-hidden mt-(--landing-stack-lg)`}>
        <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-10 bg-linear-to-r from-landing-surface to-transparent sm:w-28" />
        <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-10 bg-linear-to-l from-landing-surface to-transparent sm:w-28" />
