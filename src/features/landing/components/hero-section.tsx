        ...
        <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-black pt-16">
            ...
            <div className="container relative z-10 mx-auto grid place-items-center gap-8 px-4 text-center">
                <div className="space-y-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 fill-mode-both">
                    <div className="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-3 py-1 text-sm text-cyan-400 backdrop-blur-sm">
                        <span className="mr-2 flex h-2 w-2 rounded-full bg-cyan-400 animate-pulse"></span>
                        Techfest 2026 is Coming Soon
                    </div>

                    <h1 className="text-5xl font-extrabold tracking-tight text-white sm:text-7xl md:text-8xl lg:text-9xl">
                        ...
                        <span className="block bg-gradient-to-r from-white/50 to-white bg-clip-text text-transparent">
                            INSPIRE
                        </span>
                    </h1>
                ...
                <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-20 duration-1000 delay-200 fill-mode-both sm:flex-row">
                    ...
                    <Button size="lg" variant="outline" className="h-12 border-white/20 bg-white/5 text-white hover:bg-white/10 hover:text-white rounded-full px-8 text-lg hover:border-white/40">
                        View Schedule
